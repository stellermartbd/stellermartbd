<?php 
/**
 * Prime Beast - Dynamic RBAC Products Hub
 * Logic: Hard-locked for View, Add, Edit, Delete Permissions
 */
require_once '../core/db.php'; 
require_once '../core/functions.php'; 

// ১. মডিউল লেভেল সিকিউরিটি: ভিউ পারমিশন চেক
// 'product_manage' অথবা 'Product Manage' - ডাটাবেসের সাথে মিলিয়ে দেখবে
if (!hasPermission($conn, 'product_manage', 'view')) {
    header("Location: dashboard.php?error=Access+Denied:+No+View+Access");
    exit();
}
                                ...
                                <td class="p-4 text-right pr-6">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <?php if (!hasPermission($conn, 'product_manage', 'edit') && !hasPermission($conn, 'product_manage', 'delete')): ?>
                                            <span class="text-[10px] font-bold text-gray-400 uppercase italic">View Only</span>
                                        <?php endif; ?>
